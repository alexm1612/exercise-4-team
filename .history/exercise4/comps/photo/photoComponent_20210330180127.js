...
export default function PhotoUI({ url = "http://placekitten.com/250/250", text = "Sit in box what a cat-ass-trophy! try to hold own back foot to clean it but foot reflexively kicks you in face, go into a rage and bite own foot, hard for jump off balcony, onto stranger's head i will ruin the couch with my claws for car rides are evil. In the middle of the night i crawl onto your chest and purr gently to help you sleep purr for no reason, yet hunt by meowing loudly at 5am next to human slave food dispenser and find empty spot in cupboard and sleep all day i like fish.", catName = "Cat Name" }) {
    return (
