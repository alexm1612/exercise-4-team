...
<div style="display: flex; flex-direction: column; width: 300px; border: 1px solid black;">
    <d style="display: flex; flex-direction: row; background-color: royalblue; color: white; height: 70px; justify-content: center; align-items: center;">
      <h3>CHAT</h3>
    </div>
