...
return <div style={{
  ...
  width:mainWidth,
    ...
    <span style={{
      display: flex; flex-direction: row; background-color: royalblue; height: 70px; justify-content: space-between; align-items: center; padding-left: 10px; padding-right: 10px;}}>
