    ...
    return (
        <div className={style.container}>
            ...
            <span className={style.span}>
                ...
                <input className={style.button} type="button" value="Click Here" onInput="HandleClick()"></input>
            </span>
        </div>
    )
